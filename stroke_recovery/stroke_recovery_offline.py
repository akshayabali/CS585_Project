...
# eval_img_path_override = PROJ_ROOT / Path("data_processing/prepare_IAM_Lines/lines/")
# eval_gt_path_override = PROJ_ROOT / Path("data_processing/prepare_IAM_Lines/gts/lines/txt")
eval_img_path_override = PROJ_ROOT / Path("data_processing/test_files/lines/")
eval_gt_path_override = PROJ_ROOT / Path("data_processing/test_files/gts/lines/txt")
config_path = "/mnt/c/Users/plane/Downloads/simple_hwr/example_weights/config.yaml"
...
def eval_only(dataloader, model):
    ...
    np.save(output_path / f"all_data_test.npy", final_out)
