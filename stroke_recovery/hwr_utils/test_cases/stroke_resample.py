...
def test():
    json_path = "../../data_processing/online_coordinate_data/8_stroke_vSmall_16/train_online_coords.json"
    json_path = "/media/data_processing/GitHub/simple_hwr/data_processing/online_coordinate_data/MAX_stroke_vlargeTrnSetFull/train_online_coords.json"
    parameter = "d"
