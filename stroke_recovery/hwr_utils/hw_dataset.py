...
class HwDataset(Dataset):
    def __init__(self,
        ...
        self.stroke_path = kwargs["stroke_path"] if "stroke_path" in kwargs else "RESULTS/OFFLINE_PREDS/good/imgs/current/eval/data_processing/all_data.npy"
