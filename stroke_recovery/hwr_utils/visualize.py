...
if __name__=="__main__":
    ...
    if True:
        ...
        #path = r"/media/data_processing/GitHub/simple_hwr/RESULTS/COMPARISON"
        paths = ["/media/SuperComputerGroups/fslg_hwr/taylor_simple_hwr/RESULTS/indic/first_attempt"]
        # "/media/data_processing/GitHub/simple_hwr/RESULTS/ver4",
        ...
        path = Path("/media/data_processing/GitHub/simple_hwr/RESULTS/COMPARISON/11_")
