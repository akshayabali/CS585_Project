...
wget http://www.fki.inf.unibe.ch/DBs/iamDB/data_processing/words/words.tgz http://www.fki.inf.unibe.ch/DBs/iamDB/data_processing/xml/xml.tgz --user $iam_username --ask-password
