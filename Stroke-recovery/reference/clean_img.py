...
def test():
    paths = ("/media/data_processing/GitHub/handwriting_data/train_offline/a01-011x-03.png", "/media/data_processing/GitHub/handwriting_data/train_offline/a01-007x-07.png")
    #paths = "/media/data_processing/GitHub/handwriting_data/train_offline_preprocessed/h01-014-07.png",
    for path in paths:
        print(path)
        plot(path)

if __name__=="__main__":
    root = Path("/media/data_processing/GitHub/handwriting_data")
